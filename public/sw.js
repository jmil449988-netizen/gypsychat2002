...
var CACHE = 'gc2000-v168';
var SHELL = ['./', './index.html', './css/style.css?v=103', './js/appconfig.js?v=2', './js/app.js?v=137', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/badge-96.png', './sounds/airhorn.mp3', './sounds/badum.mp3', './sounds/boo.mp3', './sounds/burp.mp3', './sounds/cheers.mp3', './sounds/clap.mp3', './sounds/crickets.mp3', './sounds/cry.mp3', './sounds/friend-logon.mp3', './sounds/gunshot.mp3', './sounds/howl.mp3', './sounds/kiss.mp3', './sounds/knock.mp3', './sounds/laugh.mp3', './sounds/slap.mp3', './sounds/sneeze.mp3', './sounds/login.mp3', './sounds/pm.mp3', './sounds/friend-request.mp3', './sounds/game-invite.mp3', './sounds/spit.mp3', './sounds/fart.mp3', './sounds/drumroll.mp3', './sounds/ding.mp3', './sounds/buzz.mp3', './sounds/turn.mp3', './sounds/tick.mp3', './sounds/tock.mp3', './sounds/coin.mp3', './sounds/win.mp3', './sounds/lose.mp3', './sounds/hm-right.mp3', './sounds/hm-wrong.mp3', './sounds/levelup.mp3', './sounds/intro.mp3', './sounds/logout.mp3', './sounds/signoff.mp3', './sounds/unroll.mp3', './sounds/wheel.mp3', './sounds/card.mp3', './sounds/chips.mp3', './sounds/trapdoor.mp3', './sounds/fortune.mp3', './sounds/send.mp3', './sounds/recv.mp3'];
