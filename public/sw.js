...
var CACHE = 'gc2000-v65';
var SHELL = ['./', './index.html', './css/style.css?v=44', './js/appconfig.js?v=1', './js/app.js?v=51', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
