...
var CACHE = 'gc2000-v150';
var SHELL = ['./', './index.html', './css/style.css?v=95', './js/appconfig.js?v=2', './js/app.js?v=121', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/badge-96.png'];
