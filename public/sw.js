...
var CACHE = 'gc2000-v92';
var SHELL = ['./', './index.html', './css/style.css?v=55', './js/appconfig.js?v=2', './js/app.js?v=77', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
