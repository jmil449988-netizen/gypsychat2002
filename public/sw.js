...
var CACHE = 'gc2000-v77';
var SHELL = ['./', './index.html', './css/style.css?v=48', './js/appconfig.js?v=1', './js/app.js?v=62', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
