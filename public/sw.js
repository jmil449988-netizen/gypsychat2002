...
var CACHE = 'gc2000-v75';
var SHELL = ['./', './index.html', './css/style.css?v=47', './js/appconfig.js?v=1', './js/app.js?v=60', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
