...
var CACHE = 'gc2000-v157';
var SHELL = ['./', './index.html', './css/style.css?v=99', './js/appconfig.js?v=2', './js/app.js?v=126', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/badge-96.png', './sounds/airhorn.mp3', './sounds/badum.mp3', './sounds/boo.mp3', './sounds/burp.mp3', './sounds/cheers.mp3', './sounds/clap.mp3', './sounds/crickets.mp3', './sounds/cry.mp3', './sounds/friend-logon.mp3', './sounds/gunshot.mp3', './sounds/howl.mp3', './sounds/kiss.mp3', './sounds/knock.mp3', './sounds/laugh.mp3', './sounds/slap.mp3', './sounds/sneeze.mp3', './sounds/login.mp3', './sounds/pm.mp3', './sounds/friend-request.mp3', './sounds/game-invite.mp3'];
