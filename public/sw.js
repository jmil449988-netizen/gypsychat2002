...
var CACHE = 'gc2000-v28';
var SHELL = ['./', './index.html', './css/style.css?v=16', './js/appconfig.js?v=1', './js/app.js?v=24', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
