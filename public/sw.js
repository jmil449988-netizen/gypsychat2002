...
var CACHE = 'gc2000-v62';
var SHELL = ['./', './index.html', './css/style.css?v=41', './js/appconfig.js?v=1', './js/app.js?v=48', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
