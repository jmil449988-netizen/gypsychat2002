...
var CACHE = 'gc2000-v20';
var SHELL = ['./', './index.html', './css/style.css?v=12', './js/config.js?v=3', './js/app.js?v=17', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
