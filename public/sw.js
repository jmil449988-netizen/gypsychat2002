...
var CACHE = 'gc2000-v17';
var SHELL = ['./', './index.html', './css/style.css?v=11', './js/config.js?v=2', './js/app.js?v=14', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
